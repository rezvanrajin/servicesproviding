...
var Ziggy = {
  ...
  "routes": {
    ...
    "ServiceDetails": {
      "uri": "service-details\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "index.featuredServiceAll": {
      "uri": "featured\/service\/all",
      "methods": ["GET", "HEAD"]
    },
    "index.recentlyServiceAll": {
      "uri": "recently\/service\/all",
      "methods": ["GET", "HEAD"]
    },
    "index.popularServiceAll": {
      "uri": "popular\/service\/all",
      "methods": ["GET", "HEAD"]
    },
    "providerDetailsService": {
      "uri": "provider\/service-list\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "index.providerAll": {
      "uri": "provider\/all",
    ...
    "buyer.forgotPassword": {
      "uri": "buyer\/forgot-password",
      "methods": ["GET", "HEAD"]
    },
    "buyer.resetPassword": {
      "uri": "buyer\/reset-password\/{token}",
      "methods": ["GET", "HEAD"]
    },
    "buyer.login": {
      "uri": "buyer\/login",
    ...
    "buyer.redirectToGoogle": {
      "uri": "buyer\/login\/google",
      "methods": ["GET", "HEAD"]
    },
    "handleGoogleCallback": {
      "uri": "buyer\/login\/google\/callback",
      "methods": ["GET", "HEAD"]
    },
    "buyer.dashboard": {
      "uri": "buyer\/dashboard",
    ...
    "buyer.emailsupport": {
      "uri": "buyer\/emailsupport",
      "methods": ["GET", "HEAD"]
    },
    "buyer.orderInvoivePdf": {
      "uri": "buyer\/order-invoice-pdf\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "provider.login": {
      "uri": "seller",
    ...
    "provider.reset-Password": {
      "uri": "seller\/reset-password\/{token}",
      "methods": ["GET", "HEAD"]
    },
    "provider.dashboard": {
    ...
    "providers.handymans": {
      "uri": "seller\/handymans",
      "methods": ["GET", "HEAD"]
    },
    "providers.providersCoupons": {
      "uri": "seller\/providersCoupons-list",
      "methods": ["GET", "HEAD"]
    },
    "providers.services": {
      "uri": "seller\/provider-services",
      "methods": ["GET", "HEAD"]
    },
    "providers.bookings": {
      "uri": "seller\/bookings",
    ...
    "providers.assign.hadyman": {
      "uri": "seller\/handyman\/assign\/list",
      "methods": ["GET", "HEAD"]
    },
    "providers.reviews": {
      "uri": "seller\/reviews",
    ...
    "providers.emailSupport": {
      "uri": "seller\/email\/suppoert",
      "methods": ["GET", "HEAD"]
    },
    "providers.UserList": {
      "uri": "seller\/buyer-customer-list",
      "methods": ["GET", "HEAD"]
    },
    "provider.printPDFInvoice": {
      "uri": "seller\/print-order-pdf\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "provider.sellerreviewslist": {
      "uri": "seller\/sellerreviewslist",
      "methods": ["GET", "HEAD"]
    },
    "admin.login": {
      "uri": "admin",
    ...
    "admin.userMailbox": {
      "uri": "admin\/userMailbox",
      "methods": ["GET", "HEAD"]
    },
    "admin.footerSettings": {
      "uri": "admin\/footer-setting",
      "methods": ["GET", "HEAD"]
    },
    "admin.linksWidget": {
      "uri": "admin\/links-widget",
      "methods": ["GET", "HEAD"]
    },
    "admin.sociallink": {
      "uri": "admin\/social",
    ...
    "admin.orderInvoivePdf": {
      "uri": "admin\/order-invoice-pdf\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "index.getMenu": {
      "uri": "api\/getMenu",
    ...
    "getSellerReviews": {
      "uri": "api\/get-seller-reviews\/{review}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "review": "id"
      }
    },
    "index.popularService": {
      "uri": "api\/popular-service",
      "methods": ["GET", "HEAD"]
    },
    "getPopularServiceAll": {
      "uri": "api\/popular-service\/all",
      "methods": ["GET", "HEAD"]
    },
    "index.feature": {
      "uri": "api\/feature",
    ...
    "categoryDetails.ServiceList": {
      "uri": "api\/getCategory\/serviceList\/{category}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "category": "id"
      }
    ...
    "getcategoryServiceList": {
      "uri": "api\/category\/service\/List\/{category}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "category": "id"
      }
    ...
    "index.providerServiceList": {
      "uri": "api\/provider\/service-list\/{service}",
      "methods": ["GET", "HEAD"]
    },
    "getproviderServiceList": {
      "uri": "api\/provider\/service\/List\/{provider}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "provider": "id"
      }
    ...
    "providerDetails.ServiceList": {
      "uri": "api\/get-providerdetails\/serviceList\/{provider}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "provider": "id"
      }
    ...
    "getserviceDetails": {
      "uri": "api\/service-details\/{service}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "service": "id"
      }
    ...
    "providerReview": {
      "uri": "api\/provider-review",
      "methods": ["POST"]
    },
    "serviceReview": {
      "uri": "api\/service-review",
      "methods": ["POST"]
    },
    "getFeaturedServiceAll": {
      "uri": "api\/getFeatured\/service\/all",
      "methods": ["GET", "HEAD"]
    },
    "getRecentlyServiceAll": {
      "uri": "api\/getRecently\/service\/all",
      "methods": ["GET", "HEAD"]
    },
    "getProviderAll": {
      "uri": "api\/getProvider\/all",
      "methods": ["GET", "HEAD"]
    },
    "getCategoryAll": {
      "uri": "api\/getCategory\/all",
      "methods": ["GET", "HEAD"]
    },
    "getCityAll": {
      "uri": "api\/getCity\/all",
    ...
    "getCartItem": {
      "uri": "api\/get-cartIitem",
      "methods": ["GET", "HEAD"]
    },
    "deleteCartItem": {
      "uri": "api\/delete-cartIitem\/{cart}",
      "methods": ["DELETE"],
      "bindings": {
        "cart": "id"
      }
    ...
    "buyer.confirmAccount": {
      "uri": "api\/buyer\/confirm-register\/{email}",
      "methods": ["POST"]
    },
    "api.buyer.forgotPassword": {
      "uri": "api\/buyer\/forgot-password",
      "methods": ["POST"]
    },
    "buyer.reset-password": {
      "uri": "api\/buyer\/reset-password",
      "methods": ["POST"]
    },
    "buyer.profileUpdate": {
      "uri": "api\/buyer\/profile\/update",
      "methods": ["POST"]
    },
    "buyer.updatePassword": {
      "uri": "api\/buyer\/update-password",
      "methods": ["POST"]
    },
    "buyer.dashboardWidge": {
      "uri": "api\/buyer\/dashboard-widget",
      "methods": ["GET", "HEAD"]
    },
    "favorites.index": {
      "uri": "api\/buyer\/favorites",
      "methods": ["GET", "HEAD"]
    },
    "favorites.create": {
      "uri": "api\/buyer\/favorites\/create",
      "methods": ["GET", "HEAD"]
    },
    "favorites.store": {
      "uri": "api\/buyer\/favorites",
    ...
    "favorites.show": {
      "uri": "api\/buyer\/favorites\/{favorite}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "favorite": "id"
      }
    ...
    "favorites.edit": {
      "uri": "api\/buyer\/favorites\/{favorite}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "favorites.update": {
      "uri": "api\/buyer\/favorites\/{favorite}",
    ...
    "usersreviews.index": {
      "uri": "api\/buyer\/usersreviews",
      "methods": ["GET", "HEAD"]
    },
    "usersreviews.create": {
      "uri": "api\/buyer\/usersreviews\/create",
      "methods": ["GET", "HEAD"]
    },
    "usersreviews.store": {
      "uri": "api\/buyer\/usersreviews",
    ...
    "usersreviews.show": {
      "uri": "api\/buyer\/usersreviews\/{usersreview}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "usersreview": "id"
      }
    ...
    "usersreviews.edit": {
      "uri": "api\/buyer\/usersreviews\/{usersreview}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "usersreviews.update": {
      "uri": "api\/buyer\/usersreviews\/{usersreview}",
    ...
    "usersreviews.destroy": {
      "uri": "api\/buyer\/usersreviews\/{usersreview}",
      "methods": ["DELETE"]
    },
    "buyer.getCityAll": {
      "uri": "api\/buyer\/city-all",
      "methods": ["GET", "HEAD"]
    },
    "buyer.resentBooking": {
      "uri": "api\/buyer\/resentBooking",
      "methods": ["GET", "HEAD"]
    },
    "buyermail.index": {
      "uri": "api\/buyer\/buyermail",
      "methods": ["GET", "HEAD"]
    },
    "buyermail.create": {
      "uri": "api\/buyer\/buyermail\/create",
      "methods": ["GET", "HEAD"]
    },
    "buyermail.store": {
      "uri": "api\/buyer\/buyermail",
    ...
    "buyermail.show": {
      "uri": "api\/buyer\/buyermail\/{buyermail}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "buyermail": "id"
      }
    ...
    "buyermail.edit": {
      "uri": "api\/buyer\/buyermail\/{buyermail}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "buyermail.update": {
      "uri": "api\/buyer\/buyermail\/{buyermail}",
    ...
    "buyer.adminData": {
      "uri": "api\/buyer\/adminData",
      "methods": ["GET", "HEAD"]
    },
    "usersbookings.index": {
      "uri": "api\/buyer\/usersbookings",
      "methods": ["GET", "HEAD"]
    },
    "usersbookings.create": {
      "uri": "api\/buyer\/usersbookings\/create",
      "methods": ["GET", "HEAD"]
    },
    "usersbookings.store": {
      "uri": "api\/buyer\/usersbookings",
    ...
    "usersbookings.show": {
      "uri": "api\/buyer\/usersbookings\/{usersbooking}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "usersbooking": "id"
      }
    ...
    "usersbookings.edit": {
      "uri": "api\/buyer\/usersbookings\/{usersbooking}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "usersbookings.update": {
      "uri": "api\/buyer\/usersbookings\/{usersbooking}",
      "methods": ["PUT", "PATCH"]
    },
    "usersbookings.destroy": {
      "uri": "api\/buyer\/usersbookings\/{usersbooking}",
      "methods": ["DELETE"]
    },
    ...
    "admin.category.getSubcategory": {
      "uri": "api\/admin\/category\/subcategory",
      "methods": ["GET", "HEAD"]
    },
    "categories.updateCategoryStatus": {
      "uri": "api\/admin\/update-category-status",
      "methods": ["POST"]
    },
    "categories.updateCategoryFeaturedStatus": {
      "uri": "api\/admin\/update-categoryFeatured-status",
      "methods": ["POST"]
    },
    "cities.index": {
      "uri": "api\/admin\/cities",
      "methods": ["GET", "HEAD"]
    },
    "cities.create": {
      "uri": "api\/admin\/cities\/create",
      "methods": ["GET", "HEAD"]
    },
    "cities.store": {
      "uri": "api\/admin\/cities",
    ...
    "cities.show": {
      "uri": "api\/admin\/cities\/{city}",
      "methods": ["GET", "HEAD"]
    },
    "cities.edit": {
      "uri": "api\/admin\/cities\/{city}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "city": "id"
      }
    ...
    "cities.updateCityStatus": {
      "uri": "api\/admin\/update-city-status",
      "methods": ["POST"]
    },
    "providerTypes.index": {
      "uri": "api\/admin\/providerTypes",
      "methods": ["GET", "HEAD"]
    },
    "providerTypes.create": {
      "uri": "api\/admin\/providerTypes\/create",
      "methods": ["GET", "HEAD"]
    },
    "providerTypes.store": {
      "uri": "api\/admin\/providerTypes",
    ...
    "providerTypes.show": {
      "uri": "api\/admin\/providerTypes\/{providerType}",
      "methods": ["GET", "HEAD"]
    },
    "providerTypes.edit": {
      "uri": "api\/admin\/providerTypes\/{providerType}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providerType": "id"
      }
    ...
    "admins.show": {
      "uri": "api\/admin\/admins\/{admin}",
      "methods": ["GET", "HEAD"]
    },
    "admins.edit": {
      "uri": "api\/admin\/admins\/{admin}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "admin": "id"
      }
    ...
    "admins.updateAdminStatus": {
      "uri": "api\/admin\/update-admin-status",
      "methods": ["POST"]
    },
    "admin.getRoles": {
      "uri": "api\/admin\/roles",
    ...
    "providers.updateProviderStatus": {
      "uri": "api\/admin\/update-provider-status",
      "methods": ["POST"]
    },
    "providers.updatePrviderReviewStatus": {
      "uri": "api\/admin\/update-providerReview-status",
      "methods": ["POST"]
    },
    "providers.providerServiceDetails": {
      "uri": "api\/admin\/provider\/service-details\/{service}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "service": "id"
      }
    },
    "admin.provider.getProvider": {
      "uri": "api\/admin\/provider-types",
      "methods": ["GET", "HEAD"]
    },
    "admin.provider.getCity": {
      "uri": "api\/admin\/citys",
      "methods": ["GET", "HEAD"]
    },
    "admin.provider.providerHandyman": {
      "uri": "api\/admin\/provider-handyman\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.provider.service.list": {
      "uri": "api\/admin\/provider-service-list\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "handymen.adminIndex": {
      "uri": "api\/admin\/handymen",
      "methods": ["GET", "HEAD"]
    },
    "handymen.updateHandymanStatus": {
      "uri": "api\/admin\/update-handyman-status",
      "methods": ["POST"]
    },
    "handymen.handymanShow": {
      "uri": "api\/admin\/handymen\/{handyman}\/show",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "handyman": "id"
      }
    },
    "handyman.handymanDestroy": {
      "uri": "api\/admin\/handymen\/{handyman}\/destroy",
      "methods": ["DELETE"],
      "bindings": {
        "handyman": "id"
      }
    ...
    "coupons.edit": {
      "uri": "api\/admin\/coupons\/{coupon}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "coupon": "id"
      }
    ...
    "coupons.updateCouponStatus": {
      "uri": "api\/admin\/update-coupon-status",
      "methods": ["POST"]
    },
    "coupons.getService": {
      "uri": "api\/admin\/getServices",
      "methods": ["GET", "HEAD"]
    },
    "user.admiindex": {
      "uri": "api\/admin\/all-users",
      "methods": ["GET", "HEAD"]
    },
    "admin.user.indexIactive": {
      "uri": "api\/admin\/users-inactive",
      "methods": ["GET", "HEAD"]
    },
    "users.updateUserStatus": {
      "uri": "api\/admin\/update-user-status",
      "methods": ["POST"]
    },
    "admin.user.details": {
      "uri": "api\/admin\/user\/detaisl\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.user.destroy": {
    ...
    "adminsservices.index": {
      "uri": "api\/admin\/adminsservices",
      "methods": ["GET", "HEAD"]
    },
    "adminsservices.create": {
      "uri": "api\/admin\/adminsservices\/create",
      "methods": ["GET", "HEAD"]
    },
    "adminsservices.store": {
      "uri": "api\/admin\/adminsservices",
      "methods": ["POST"]
    },
    "adminsservices.show": {
      "uri": "api\/admin\/adminsservices\/{adminsservice}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "adminsservice": "id"
      }
    ...
    "adminsservices.edit": {
      "uri": "api\/admin\/adminsservices\/{adminsservice}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "adminsservice": "id"
      }
    },
    "adminsservices.update": {
      "uri": "api\/admin\/adminsservices\/{adminsservice}",
      "methods": ["PUT", "PATCH"],
      "bindings": {
        "adminsservice": "id"
    ...
    "adminsservices.updateadminsServiceReviewStatus": {
      "uri": "api\/admin\/update-adminsserviceReview-status",
      "methods": ["POST"]
    },
    "adminsservices.UpdateadminServiceStatus": {
      "uri": "api\/admin\/update-adminsservice-status",
      "methods": ["POST"]
    },
    "adminsservice.updateAdminsserviceFeaturedStatus": {
      "uri": "api\/admin\/update-adminsserviceFeatured-status",
      "methods": ["POST"]
    },
    "admin.service.getCategory": {
      "uri": "api\/admin\/category\/getCategory",
      "methods": ["GET", "HEAD"]
    },
    "admin.service.getSubCategory": {
      "uri": "api\/admin\/subcategory\/getSubCategory",
      "methods": ["GET", "HEAD"]
    },
    "admin.service.getproviders": {
      "uri": "api\/admin\/provider\/getprovider",
      "methods": ["GET", "HEAD"]
    },
    "admin.service.activeStatus": {
      "uri": "api\/admin\/provider\/status\/active\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.service.inactiveStatus": {
      "uri": "api\/admin\/provider\/status\/inactive\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "adminbookings.adminIndex": {
      "uri": "api\/admin\/adminbookings",
      "methods": ["GET", "HEAD"]
    },
    "adminbookings.admindestroy": {
      "uri": "api\/admin\/adminbookings\/{booking}",
      "methods": ["DELETE"],
      "bindings": {
        "booking": "id"
      }
    },
    "adminbookings.adminShow": {
      "uri": "api\/admin\/adminbookings\/{booking}\/show",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "booking": "id"
      }
    ...
    "admin.recentBooking": {
      "uri": "api\/admin\/recent-booking",
      "methods": ["GET", "HEAD"]
    },
    "admin.booking.invoice": {
      "uri": "api\/admin\/booking\/invoice\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.invoicePDFdownload": {
      "uri": "api\/admin\/booking\/invoicePDFdownload{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.getting.SEOget": {
      "uri": "api\/admin\/seo-setting",
      "methods": ["GET", "HEAD"]
    },
    "admin.getting.SEOUpdate": {
      "uri": "api\/admin\/seo-setting-store",
      "methods": ["POST"]
    },
    "menus.index": {
      "uri": "api\/admin\/menus",
    ...
    "menus.show": {
      "uri": "api\/admin\/menus\/{menu}",
      "methods": ["GET", "HEAD"]
    },
    "menus.edit": {
      "uri": "api\/admin\/menus\/{menu}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "menu": "id"
      }
    ...
    "menus.updateMenuStatus": {
      "uri": "api\/admin\/update-menu-status",
      "methods": ["POST"]
    },
    "admin.headerMenuShow": {
      "uri": "api\/admin\/headerMenuShow",
      "methods": ["GET", "HEAD"]
    },
    "admin.headerMenustore": {
      "uri": "api\/admin\/headerMenustore",
      "methods": ["POST"]
    },
    "admin.HeaderMenuEdit": {
      "uri": "api\/admin\/HeaderMenuEdit\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.HeaderMenuDelete": {
      "uri": "api\/admin\/HeaderMenuDelete\/{id}",
      "methods": ["DELETE"]
    },
    "admin.getting-setting.edit": {
      "uri": "api\/admin\/general-setting",
      "methods": ["GET", "HEAD"]
    },
    "admin.getting-setting.update": {
      "uri": "api\/admin\/general-setting-update",
      "methods": ["POST"]
    },
    "pages.index": {
      "uri": "api\/admin\/pages",
    ...
    "admin.footer-setting.edit": {
      "uri": "api\/admin\/footer-setting",
      "methods": ["GET", "HEAD"]
    },
    "admin.footer-setting.update": {
      "uri": "api\/admin\/footer-setting-update",
      "methods": ["POST"]
    },
    "linksWidgets.index": {
      "uri": "api\/admin\/linksWidgets",
      "methods": ["GET", "HEAD"]
    },
    "linksWidgets.create": {
      "uri": "api\/admin\/linksWidgets\/create",
      "methods": ["GET", "HEAD"]
    },
    "linksWidgets.store": {
      "uri": "api\/admin\/linksWidgets",
    ...
    "linksWidgets.show": {
      "uri": "api\/admin\/linksWidgets\/{linksWidget}",
      "methods": ["GET", "HEAD"]
    },
    "linksWidgets.edit": {
      "uri": "api\/admin\/linksWidgets\/{linksWidget}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "linksWidget": "id"
      }
    ...
    "social_links.index": {
      "uri": "api\/admin\/social_links",
      "methods": ["GET", "HEAD"]
    },
    "social_links.create": {
      "uri": "api\/admin\/social_links\/create",
      "methods": ["GET", "HEAD"]
    },
    "social_links.store": {
      "uri": "api\/admin\/social_links",
    ...
    "social_links.show": {
      "uri": "api\/admin\/social_links\/{social_link}",
      "methods": ["GET", "HEAD"]
    },
    "social_links.edit": {
      "uri": "api\/admin\/social_links\/{social_link}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "social_link": "id"
      }
    ...
    "admin.dashboard.widget": {
      "uri": "api\/admin\/dashboard-widget",
      "methods": ["GET", "HEAD"]
    },
    "admin.sendMailProvider": {
      "uri": "api\/admin\/send-mail-provider",
      "methods": ["POST"]
    },
    "admin.MailboxShow": {
      "uri": "api\/admin\/MailboxShow",
      "methods": ["GET", "HEAD"]
    },
    "admin.MailView": {
      "uri": "api\/admin\/MailView\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.MailDelete": {
      "uri": "api\/admin\/MailDelete\/{id}",
      "methods": ["DELETE"]
    },
    "admin.replayMail": {
      "uri": "api\/admin\/replay-mail\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.replaySednMail": {
      "uri": "api\/admin\/replay-mail",
      "methods": ["POST"]
    },
    "admin.userMailboxShow": {
      "uri": "api\/admin\/UserMailboxShow",
      "methods": ["GET", "HEAD"]
    },
    "admin.UserMailView": {
      "uri": "api\/admin\/userMailView\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.UserReplayMail": {
      "uri": "api\/admin\/Userreplay-mail\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "admin.UserReplaySednMail": {
      "uri": "api\/admin\/Userreplay-mailSend",
      "methods": ["POST"]
    },
    "admin.UserMailDelete": {
      "uri": "api\/admin\/UserMailDelete\/{id}",
      "methods": ["DELETE"]
    },
    "mailboxs.index": {
      "uri": "api\/admin\/mailboxs",
      "methods": ["GET", "HEAD"]
    },
    "mailboxs.create": {
      "uri": "api\/admin\/mailboxs\/create",
      "methods": ["GET", "HEAD"]
    },
    "mailboxs.store": {
      "uri": "api\/admin\/mailboxs",
    ...
    "mailboxs.show": {
      "uri": "api\/admin\/mailboxs\/{mailbox}",
      "methods": ["GET", "HEAD"]
    },
    "mailboxs.edit": {
      "uri": "api\/admin\/mailboxs\/{mailbox}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "mailboxs.update": {
      "uri": "api\/admin\/mailboxs\/{mailbox}",
    ...
    "emails.getResentMail": {
      "uri": "api\/admin\/getResentMail",
      "methods": ["GET", "HEAD"]
    },
    ...
    "provider.profileUpdate": {
      "uri": "api\/provider\/profile\/update",
      "methods": ["POST"]
    },
    "provider.updatePassword": {
      "uri": "api\/provider\/update-password",
      "methods": ["POST"]
    },
    "provider.sellerUserList": {
      "uri": "api\/provider\/buyer-booking-list",
      "methods": ["GET", "HEAD"]
    },
    "handymen.index": {
      "uri": "api\/provider\/handymen",
      "methods": ["GET", "HEAD"]
    },
    "handymen.create": {
      "uri": "api\/provider\/handymen\/create",
      "methods": ["GET", "HEAD"]
    },
    "handymen.store": {
      "uri": "api\/provider\/handymen",
    ...
    "handymen.show": {
      "uri": "api\/provider\/handymen\/{handyman}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "handyman": "id"
      }
    ...
    "handymen.edit": {
      "uri": "api\/provider\/handymen\/{handyman}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "handyman": "id"
      }
    ...
    "handyman.getAllCity": {
      "uri": "api\/provider\/cities-all",
      "methods": ["GET", "HEAD"]
    },
    "sellerReviews.index": {
      "uri": "api\/provider\/sellerReviews",
      "methods": ["GET", "HEAD"]
    },
    "sellerReviews.create": {
      "uri": "api\/provider\/sellerReviews\/create",
      "methods": ["GET", "HEAD"]
    },
    "sellerReviews.store": {
      "uri": "api\/provider\/sellerReviews",
    ...
    "sellerReviews.show": {
      "uri": "api\/provider\/sellerReviews\/{sellerReview}",
      "methods": ["GET", "HEAD"]
    },
    "sellerReviews.edit": {
      "uri": "api\/provider\/sellerReviews\/{sellerReview}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "sellerReviews.update": {
      "uri": "api\/provider\/sellerReviews\/{sellerReview}",
      "methods": ["PUT", "PATCH"]
    },
    ...
    "services.create": {
      "uri": "api\/provider\/services\/create",
      "methods": ["GET", "HEAD"]
    },
    "services.store": {
      "uri": "api\/provider\/services",
    ...
    "services.show": {
      "uri": "api\/provider\/services\/{service}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "service": "id"
      }
    ...
    "services.edit": {
      "uri": "api\/provider\/services\/{service}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "service": "id"
      }
    ...
    "services.updateServiceFeaturedStatus": {
      "uri": "api\/provider\/update-serviceFeatured-status",
      "methods": ["POST"]
    },
    "provider.category.getCategory": {
      "uri": "api\/provider\/category",
      "methods": ["GET", "HEAD"]
    },
    "provider.service.getCategory": {
      "uri": "api\/provider\/categories",
      "methods": ["GET", "HEAD"]
    },
    "providersCoupons.index": {
      "uri": "api\/provider\/providersCoupons",
      "methods": ["GET", "HEAD"]
    },
    "providersCoupons.create": {
      "uri": "api\/provider\/providersCoupons\/create",
      "methods": ["GET", "HEAD"]
    },
    "providersCoupons.store": {
      "uri": "api\/provider\/providersCoupons",
      "methods": ["POST"]
    },
    "providersCoupons.show": {
      "uri": "api\/provider\/providersCoupons\/{providersCoupon}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providersCoupon": "id"
      }
    },
    "providersCoupons.edit": {
      "uri": "api\/provider\/providersCoupons\/{providersCoupon}\/edit",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providersCoupon": "id"
      }
    },
    "providersCoupons.update": {
      "uri": "api\/provider\/providersCoupons\/{providersCoupon}",
      "methods": ["PUT", "PATCH"],
      "bindings": {
        "providersCoupon": "id"
    ...
    "providersCoupons.updateCouponStatus": {
      "uri": "api\/provider\/update-providersCoupon-status",
      "methods": ["POST"]
    },
    "providersCoupons.getUserAll": {
      "uri": "api\/provider\/getUserAll",
      "methods": ["GET", "HEAD"]
    },
    "providersbookings.index": {
      "uri": "api\/provider\/providersbookings",
      "methods": ["GET", "HEAD"]
    },
    "providersbookings.create": {
      "uri": "api\/provider\/providersbookings\/create",
      "methods": ["GET", "HEAD"]
    },
    "providersbookings.store": {
      "uri": "api\/provider\/providersbookings",
      "methods": ["POST"]
    },
    "providersbookings.show": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providersbooking": "id"
      }
    },
    "providersbookings.edit": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "providersbookings.update": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}",
      "methods": ["PUT", "PATCH"]
    },
    "providersbookings.destroy": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}",
      "methods": ["DELETE"],
      "bindings": {
        "providersbooking": "id"
    ...
    "providersbookings.bookingStatus": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}\/status",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providersbooking": "id"
      }
    },
    "providersbookings.bookingAssignHandyman": {
      "uri": "api\/provider\/providersbookings\/{providersbooking}\/assignHandyman",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "providersbooking": "id"
      }
    },
    "providersbookings.status": {
      "uri": "api\/provider\/providersbookings\/status\/{providersbooking}",
      "methods": ["POST"],
      "bindings": {
        "providersbooking": "id"
      }
    },
    "providersbookings.getHandymanAll": {
      "uri": "api\/provider\/get-handyman",
      "methods": ["GET", "HEAD"]
    },
    "providersbookings.handymanAssign": {
      "uri": "api\/provider\/handyman\/assign",
      "methods": ["POST"]
    },
    "provider.review.index": {
      "uri": "api\/provider\/reviews",
      "methods": ["GET", "HEAD"]
    },
    "provider.review.destroy": {
      "uri": "api\/provider\/reviews\/{id}",
      "methods": ["DELETE"]
    },
    "provider.review.details": {
      "uri": "api\/provider\/review\/detaisl\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "assign_handymen.index": {
      "uri": "api\/provider\/assign_handymen",
      "methods": ["GET", "HEAD"]
    },
    "assign_handymen.create": {
      "uri": "api\/provider\/assign_handymen\/create",
      "methods": ["GET", "HEAD"]
    },
    "assign_handymen.store": {
      "uri": "api\/provider\/assign_handymen",
      "methods": ["POST"]
    },
    "assign_handymen.show": {
      "uri": "api\/provider\/assign_handymen\/{assign_handyman}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "assign_handyman": "id"
      }
    },
    "assign_handymen.edit": {
      "uri": "api\/provider\/assign_handymen\/{assign_handyman}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "assign_handymen.update": {
      "uri": "api\/provider\/assign_handymen\/{assign_handyman}",
      "methods": ["PUT", "PATCH"]
    },
    "assign_handymen.destroy": {
      "uri": "api\/provider\/assign_handymen\/{assign_handyman}",
      "methods": ["DELETE"]
    },
    "provider.payment.lnformationList": {
      "uri": "api\/provider\/payment-information-list",
      "methods": ["GET", "HEAD"]
    },
    "provider.payment.lnformation": {
      "uri": "api\/provider\/payment-information",
      "methods": ["POST"]
    },
    "provider.payment.lnformationDestroy": {
      "uri": "api\/provider\/payment-information-delete\/{id}",
      "methods": ["DELETE"]
    },
    "provider.profile.getWidget": {
      "uri": "api\/provider\/profile-widget",
      "methods": ["GET", "HEAD"]
    },
    "sellersupport.index": {
      "uri": "api\/provider\/sellersupport",
      "methods": ["GET", "HEAD"]
    },
    "sellersupport.create": {
      "uri": "api\/provider\/sellersupport\/create",
      "methods": ["GET", "HEAD"]
    },
    "sellersupport.store": {
      "uri": "api\/provider\/sellersupport",
    ...
    "sellersupport.show": {
      "uri": "api\/provider\/sellersupport\/{sellersupport}",
      "methods": ["GET", "HEAD"],
      "bindings": {
        "sellersupport": "id"
      }
    ...
    "sellersupport.edit": {
      "uri": "api\/provider\/sellersupport\/{sellersupport}\/edit",
      "methods": ["GET", "HEAD"]
    },
    "sellersupport.update": {
      "uri": "api\/provider\/sellersupport\/{sellersupport}",
      "methods": ["PUT", "PATCH"]
    },
    "sellersupport.destroy": {
      "uri": "api\/provider\/sellersupport\/{sellersupport}",
      "methods": ["DELETE"],
      "bindings": {
        "sellersupport": "id"
    ...
    "provider.adminData": {
      "uri": "api\/provider\/adminData",
      "methods": ["GET", "HEAD"]
    },
    "provider.resentBooking": {
      "uri": "api\/provider\/resent-booking",
      "methods": ["GET", "HEAD"]
    },
    "provider.topSellService": {
      "uri": "api\/provider\/top-sell-service",
      "methods": ["GET", "HEAD"]
    },
    "provider.resentReview": {
      "uri": "api\/provider\/resent-review",
      "methods": ["GET", "HEAD"]
    },
    "provider.providerCustomerList": {
      "uri": "api\/provider\/provider\/customer-list\/{id}",
      "methods": ["GET", "HEAD"]
    },
    "provider.serviceProfile": {
      "uri": "api\/provider\/service-profile",
      "methods": ["GET", "HEAD"]
    },
    "provider.dashboardWidget": {
      "uri": "api\/provider\/dashboard-widget",
      "methods": ["GET", "HEAD"]
    }
  }
};
