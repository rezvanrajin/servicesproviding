@php
    $html_tag_data = [];
    $title = 'Mail Support';
    $description= 'Mail List for Buyer';
@endphp
      ...
      <div class="col">
        ...
        <div class="page-title-container">
          <div class="row">
            <!-- Title Start -->
            <div class="col-md-8">
                <h4 id="title" >Mail List</h4>
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb" >
                  <ul class="breadcrumb" style="background-color: #f8f9fc">
                  <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="{{route('user.support')}}">Mail list</a></li>
                </ul>
              </nav>
            </div>
            <!-- Title End -->
...
@endsection
@section('js_page')
<script src="{{asset('backend/user/custom_js/email.js')}}"></script>
@endsection
