@php
    $html_tag_data = [];
    $title = 'Review List';
    $description= 'Review List for User';
@endphp
      ...
      <div class="col">
        ...
        <div class="page-title-container">
          <div class="row">
            <!-- Title Start -->
            <div class="col-md-8">
              <h4 id="title" >Review List</h4>
              <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb" >
                <ul class="breadcrumb" style="background-color: #f8f9fc">
                  <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="{{route('user.reviews')}}">Review</a></li>
                </ul>
              </nav>
            </div>
            <!-- Title End -->
        ...
        <div class="data-table-rows slim">
          ...
          <div class="data-table-responsive-wrapper">
            <table id="BuyerReview" class="data-table nowrap w-100">
...
@endsection
@section('js_page')
<script src="{{asset('backend/user/custom_js/review.js')}}"></script>
@endsection
