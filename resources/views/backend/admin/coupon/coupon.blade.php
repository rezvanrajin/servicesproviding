@php
    $html_tag_data = [];
    $title = 'Coupon List';
    $description= 'Coupon List for Admin';
@endphp
...
<script src="{{asset('backend/admin/js/lib/moment-with-locales.min.js')}}"></script>
      ...
      <div class="col">
              ...
              <div class="col-md-8">
                ...
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb" >
                  <ul class="breadcrumb" style="background-color: #f8f9fc">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('admin.coupon')}}">Coupon</a></li>
                  </ul>
                </nav>
              </div>
              <!-- Title End -->
        ...
        <div class="data-table-rows slim">
          ...
          <div class="data-table-responsive-wrapper">
            <table id="coupons" class="data-table nowrap w-100">
              ...
              <div class="modal-body">
                <form name="couponForm" id="couponForm">
                  ...
                  <div class="mb-3">
                    ...
                    <select name="service_id" class="select2" id="service_id"  multiple>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form name="update_coupons_from" id="update_coupons_from">
                  ...
                  <div class="mb-3">
                    <label class="form-label">Service Name</label>
                    <select name="service_id[]" class="select2" multiple="multiple" id="edit_service_id">
                      <option value="">Select Service</option>
                    </select>
                    <small class="text-danger" id="service_idError"></small>
                  </div>
...
<div class="modal fade" id="couponDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelDefault" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabelDefault">Coupon Information</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
...
@endsection
@section('js_page')
<script src="{{asset('backend/admin/custom_js/coupon.js')}}"></script>
